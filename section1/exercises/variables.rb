...
"#{name} must not return to Hogwarts!"
...
is_hungry = false
number_of_pets = 1
puts "Hi #{first_name}, so you have #{number_of_pets} pet, and you are hungry? #{is_hungry}"
# IN WORDS:
# How did you decide to use the data type you did for each of the three variables above?
# I used the 3 variables and I assigned each variable with a string or a integer.
#Then I printed the answers in a question form
...
puts "There are #{number_of_snacks} total snacks in the pantry"
...
# Did you run this file in your terminal to make sure everything printed out to the terminal
  # as you would expect?
  #It did run ecactly how I expected.
